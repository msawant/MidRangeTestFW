...
_c_int00: .asmfunc
	...
	;------------------------------------------------------
	;* SET TO SUPERVISOR MODE (0x13). Other potential modes - User=0x10, System=0x1F
        ;*------------------------------------------------------
        MRS     r0, cpsr
        ...
        ;*------------------------------------------------------
	;* SET THE CONTROL MODE. ICache enabled, DCache disable, Little-endian, MMU disabled
        ;*------------------------------------------------------
	MRC      p15,#0x0,r0,c1,c0,#0
        MOV      r3,#0x1000			;Enable ICache
        ORR      r0,r0,r3	
        BIC 	 r0, r0, #0x45		;Little Endian Mode, DCache disabled, MMU disabled
